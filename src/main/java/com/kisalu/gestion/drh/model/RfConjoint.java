...
@Entity
@Table(name = "rf_conjoint")
public class RfConjoint {
    ...
    @Column(name = "acte_mariage")
    private String acteMariage;
    ...
    public String getActeMariage() {
        return acteMariage;
    }

    public void setActeMariage(String acteMariage) {
