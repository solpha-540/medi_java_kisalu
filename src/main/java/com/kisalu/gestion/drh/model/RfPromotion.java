...
@Entity
@Table(name = "rf_promotion")
public class RfPromotion {
    ...
    @Column(name = "libele_promotion", nullable = false)
    private String libelePromotion;
    ...
    public String getLibelePromotion() {
        return libelePromotion;
    }

    public void setLibelePromotion(String libelePromotion) {
        this.libelePromotion = libelePromotion;
    }
